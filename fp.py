...
with st.echo(code_location='below'):
    ...
    This is final project for Data science course.

    * Check our telegram bot: http://t.me/k_pop_idols_bot

    In this project we used:
    * обработка данных с помощью pandas
    * веб-скреппинг с помощью beautifulsoup (в коде бота)
    * визуализация данных
    * streamlit
    * регулярные выражения (в коде бота)
    * работа с геоданными с помощью geopandas
    * Дополнительные технологии (телеграм-бот)
